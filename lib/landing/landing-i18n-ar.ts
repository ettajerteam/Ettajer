...
export const AR_COPY: LandingCopy = {
  ...
  faq: {
    ...
    subtitle: "إجابات سريعة حول الإعداد وإعلانات Meta والأسعار والهجرة والإطلاق.",
    ...
    items: [
      ...
      {
        category: "المدفوعات",
        question: "هل يمكن قبول البطاقات وPayPal؟",
        answer:
          "نعم. من الإعدادات → المدفوعات اربط Stripe للبطاقات (Apple Pay / Google Pay) وPayPal بـ Client ID والسر. تذهب الأموال إلى حسابك — إيتاجر لا يحتفظ بأموال العملاء. أبقِ COD للتوصيل نقداً. راجع مركز المساعدة: إعداد المدفوعات عبر الإنترنت.",
      },
      {
        category: "COD",
      ...
      {
        category: "التسويق",
        question: "كيف أربط Meta Pixel وConversions API؟",
        answer:
          "افتح التسويق → Meta واضغط Connect with Meta لاختيار بكسل — يحفظ إيتاجر أيضاً رمز Conversions API. فعّل أحداث الشراء وإضافة للسلة. يشترك Pixel وCAPI في نفس event_id لدمج التحويلات. مركز المساعدة يغطي الكتالوج والجماهير والتحقق من النطاق.",
      },
      {
        category: "التسويق",
        question: "هل يمكن تشغيل Dynamic Ads من كتالوج إيتاجر؟",
        answer:
          "نعم. التسويق → Meta → Catalog يوفّر رابط تغذية منتجات مجدولة. أضفه في Commerce Manager كمصدر مجدول. معرّفات المنتجات تطابق content_ids في Pixel لإعلانات Dynamic وAdvantage+. اربط نطاقاً مخصصاً إن احتجت أيضاً التحقق من نطاق Meta لـ AEM.",
      },
      {
        category: "التسويق",
        question: "كيف أختبر أحداث Meta قبل إنفاق الإعلانات؟",
        answer:
          "فعّل وضع الاختبار ضمن التسويق → Meta → Advanced والصق رمز TEST من Events Manager. أكمل طلباً صغيراً على المتجر الحي، ثم راجع Test events في Meta وتشخيصات إيتاجر لأزواج Pixel وCAPI بنفس event_id. عطّل وضع الاختبار قبل الحملات الحقيقية.",
      },
      {
        category: "الكتالوج",
        question: "هل يمكن بيع منتجات رقمية أو دروبشيبينغ؟",
        answer:
          "نعم. أنشئ منتجاً رقمياً لرفع كتب PDF، أو اختر دروبشيبينغ للاستيراد من AliExpress أو CJ أو BigBuy. المتغيرات والمخزون وCOD تعمل كما في المنتجات المادية. مركز المساعدة يشرح التسليم الرقمي وتنفيذ المورد.",
      },
      {
        category: "النطاقات",
      ...
      },
      {
        ...
        answer:
          "باقات Growth وBusiness تشمل 0% رسوم Ettajer — تحتفظ بمزيد من كل بيعة COD أو أونلاين. Starter يشمل رسوم منصة صغيرة. Stripe وPayPal يفرضان رسومهما عند الدفع الإلكتروني؛ COD بلا رسوم بطاقة.",
      },
      {
        category: "النمو",
        question: "ما الذي يجعل Ettajer أفضل للمغرب من Shopify؟",
        answer:
          "Ettajer مبني حول COD مع Stripe وPayPal اختياريين: حقول دفع محلية، تحقق واتساب، حماية من الطلبات الوهمية، التحقق من العنوان وأتمتة الطلبات جاهزة. بدون إضافات — متجر ولوحة مصممان لكيفية بيع التجار المغاربة فعلياً.",
      },
    ],
  },
  cta: {
