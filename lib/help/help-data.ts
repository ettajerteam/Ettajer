...
export type HelpArticle = {
  ...
  body: string[];
  popular?: boolean;
  /** Step-by-step tutorial highlighted in Get help */
  tutorial?: boolean;
  keywords?: string[];
};
...
export function getDeveloperArticles(): HelpArticle[] {
  return getArticlesByCategory("developers");
}

export function getDeveloperTutorials(): HelpArticle[] {
  return getDeveloperArticles().filter((article) => article.tutorial);
}
