...
var svgWorldMap = (function() { 
    ...
    var options = {
        // Base path 
        libPath: '/world-map/', // Point to library folder
        mountElement: null, // Optional DOM element to mount map into
        containerId: 'svg-world-map-container', // Container element id
        // Basic options
    ...
    function initMap() {
        ...
        if (document.getElementById(options.containerId) == null) {
            // Add SVG container HTML
            var container = document.createElement("div");
            container.setAttribute("id", options.containerId);
            container.style.width = '100%';
            container.style.height = '100%';
            var mountTarget = options.mountElement || document.body;
