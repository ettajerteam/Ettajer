...
import { DOMAIN_REGISTRAR_GUIDES } from "@/lib/help/help-checklist";
...
export function HelpDomainGuidesSection() {
  const { copy } = useHelpLocale();
  const g = copy.domainGuides;
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
        ...
        <div className="md:hidden">
          <LandingCarousel
            ...
            gap={12}
          >
            {DOMAIN_REGISTRAR_GUIDES.map((item, index) => {
